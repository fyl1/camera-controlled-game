(function() {
    ...
    var Ba, Ca = "undefined" !== typeof TextDecoder,
        Da, Ea = "undefined" !== typeof TextEncoder;
    ...
    function T(a, b, c) {
        ...
        if (c)
            for (b = 0; b < c.length; b++) a = c[b], a < this.l ? (a += this.j, (d = this.g[a]) ? fb(d) : this.g[a] = mb) : (nb(this), (d = this.h[a]) ? fb(d) : this.h[a] = mb)
    }
    ...
    function yb(a, b, c) {
        ...
        if (128 <= e)
            for (f = 0; 5 > f && 128 <= e; f++) e = d.h[d.g++], a |= (e & 127) << 7 * f + 3;
        if (128 > e) {
            d = g >>> 0;
            e = a >>> 0;
    ...
    function lc(a) {
        ...
        return H(function(l) {
            ...
            a.B = {};
            if (a.g.listeners)
                for (g = C(a.g.listeners), f = g.next(); !f.done; f = g.next()) k = f.value, mc(a, k);
            h = a.j;
            a.j = {};
            a.setOptions(h);
            l.g = 0
                                ...
                                switch (h.type) {
                                    ...
                                    case "detections":
                                        ...
                                        for (w = 0; w < m.length; ++w) {
                                            ...
                                            if (t.M)
                                                for (v = 0; v < t.M.length; ++v) A = q.data, I = A.addClassification, D = w, u = t.M[v], z = new Cb, V(z, 2, u.score), u.index && V(z, 1, u.index), u.label && V(z, 3, u.label), u.displayName && V(z, 4, u.displayName), u = wb(z, Eb), I.call(A, D, u)
                                        }
                                        q = q.data;
                                        break a;
                                    default:
        ...
        return H(function(v) {
            switch (v.g) {
                ...
                case 2:
                    ...
                    if ("texture" !==
                        r.type) throw Error("Unknown output config type: '" + r.type + "'");
                    m = a.s[n];
    ...
    function rc(a) {
        ...
        this.g = new ic({
            ...
            listeners: [{
                wants: ["multi_hand_landmarks", "multi_hand_world_landmarks", "image_transformed", "multi_handedness"],
                outs: {
            ...
            options: {
                useCpuInference: {
                    ...
                    default: window.IOS_VERSION && window.IOS_VERSION < 15
                    // default: "iPad Simulator;iPhone Simulator;iPod Simulator;iPad;iPhone;iPod".split(";").includes(
